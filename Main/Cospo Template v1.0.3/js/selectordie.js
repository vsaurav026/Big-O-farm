...
;(function ($) {
    ...
    $.fn.selectOrDie = function (method) {
        ...
        var _private = {
            ...
            initSoD: function initSoD(options) {
            ...
            populateSoD: function populateSoD($option, $sodList, $sod, $isPlaceholder) {
            ...
            triggerSod: function triggerSod(e) {
                e.stopPropagation();
            ...
            keyboardUse: function keyboardUse(e) {
                var $sod = $(this),
                    $sodList = $sod.find(".sod_list"),
            ...
            checkViewport: function checkViewport($sod, $sodList) {
            ...
            listScroll: function listScroll($sodList, $option) {
                var $scrollList = $sodList[0].getBoundingClientRect(),

                // getBoundingClientRect FTW!
...
//# sourceMappingURL=selectordie.js.map